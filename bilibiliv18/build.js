...
const moduleOrder = [
    ...
    { name: 'Pagination', path: 'ui/components' },
    { name: 'Switch', path: 'ui/components' },
    { name: 'AddGroup', path: 'ui/components' },
    { name: 'VideoController', path: 'modules' },
    { name: 'Storage', path: 'modules' },
    { name: 'FavoritesGroups', path: 'modules' },
    { name: 'Favorites', path: 'modules' },
    { name: 'Notes', path: 'modules' },
    { name: 'CardPanel', path: 'ui/views' },
    { name: 'SystemMenu', path: 'ui/views/controlpanel' },
    { name: 'SpeedMenu', path: 'ui/views/controlpanel' },
    { name: 'FavoritesMenu', path: 'ui/views/controlpanel' },
    { name: 'NotesMenu', path: 'ui/views/controlpanel' },
    { name: 'ControlPanel', path: 'ui/views/controlpanel' },
    { name: 'AddToFavoritesModal', path: 'ui/views/favorites' },
    { name: 'FavoritesPanel', path: 'ui/views/favorites' },
    { name: 'FavoritesGroupPanel', path: 'ui/views/favorites' },
    { name: 'FavoritesGroupFormPanel', path: 'ui/views/favorites' },
